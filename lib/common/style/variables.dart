...
class GZXConstant {
  ...
  static TextStyle appBarTitleWhiteTextStyle = TextStyle(fontSize: ScreenUtil().setSp(18), color: Colors.white);

  static TextStyle appBarTitleBlackTextStyle = TextStyle(fontSize: ScreenUtil().setSp(16), color: Colors.black);

  static TextStyle searchResultItemCommentCountStyle = TextStyle(fontSize: ScreenUtil().setSp(12), color: Color(0xFF999999));
